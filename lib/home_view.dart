              ...
              Container(
                ...
                child: ClipRRect(
                    ...
                    child: Image(
                        ...
                        image:
                            NetworkImage(document.data['Image Poster Link']))),
              ),
              SizedBox(
                width: MediaQuery.of(context).size.width * 0.7,
                child: Container(
        ...
        children: <Widget>[
            ...
            child: Row(
              children: <Widget>[
                Text(
                  ...
                  style: TextStyle(
                      fontSize: 20, color: Colors.white, fontFamily: 'Qanelas'
          ...
          StreamBuilder(
              stream: Firestore.instance
                  ...
                  .orderBy('Date')
                  .where('Date',
                      isGreaterThan: DateTime.now().add(Duration(minutes: 330)))
                  .snapshots(),
